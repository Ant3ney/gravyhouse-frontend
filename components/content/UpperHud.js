...
function UpperHud(props){
    ...
    return(
        <View
         style={{...basic.gridContainer, ...upper.container}}
        >
            <Text
            ...
            >
                <Text
                 style={basic.gridSCol2}
                >
                    Power: {power} / 10,000</Text>
                <Text
                 style={basic.gridSCol2}
                >
                    Effectivness: {effectivness} / 50
                </Text>    
            </View>
            ...
            >
                ...
                style={basic.gridSCol2}
                >
                    Skill: {mStats.getPlayer() ? mStats.getPSkill() : 0} / 20
                </Text>
                <Text
                style={basic.gridSCol2}
                >
            ...
            >
                ...
                <Text
                 style={basic.gridSCol2}
                >
                    Time: {(Math.floor(time / 100) + ":"  + (((time % 100) < 10) ? "0" : "") + (time % 100) + " " + ( ( (Math.floor(time / 100)) === 11 ) ? "am" : "pm" ))}
                </Text>
            </View>
            <View
             style={basic.gridRow}
